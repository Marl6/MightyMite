...
if(isset($_POST['btnreset'])){
  ...
  $cpass    = $_POST['cpass'];
   ...
   $user = new User();
    ...
    $res = $user->findCURCustomer($email, $idnumer);
    if ($res == 1){
      if ($newpass == $cpass) {
        $emp = new User();
        ...
        message("Username or Customer ID does not exist!","error");
         redirect("#");
       }
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <form action="" method="POST">
          ...
          <div class="form-group">
            <label for="exampleInputPassword1">Customer ID Number</label>
            <input class="form-control" id="exampleInputPassword1" name="EMPID" type="text" placeholder="Customer ID Number" required>
          </div>
          <div class="form-group">
